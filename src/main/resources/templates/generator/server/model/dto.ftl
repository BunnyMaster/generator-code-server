...
@Data
@Schema(name = "${formatterTableNameByUppercaseName}DTO", title = "${metaData.comment}", description = "${metaData.comment}DTO类")
public class ${formatterTableNameByUppercaseName}DTO extends BasePageDTO {
