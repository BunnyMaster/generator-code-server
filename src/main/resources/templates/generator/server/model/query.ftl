...
@Data
@Schema(name = "${formatterTableNameByUppercaseName}Query", title = "${metaData.comment}", description = "${metaData.comment}Query类")
public class ${formatterTableNameByUppercaseName}Query extends BasePageDTO {
