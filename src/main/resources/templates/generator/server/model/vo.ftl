...
@NoArgsConstructor
@Builder
@Schema(name = "${formatterTableNameByUppercaseName}VO", title = "${metaData.comment}", description = "${metaData.comment}VO类")
public class ${formatterTableNameByUppercaseName}VO {
