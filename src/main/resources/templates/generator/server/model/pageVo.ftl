...
@NoArgsConstructor
@Builder
@Schema(name = "${formatterTableNameByUppercaseName}PageVO", title = "${metaData.comment}", description = "${metaData.comment}PageVO类")
public class ${formatterTableNameByUppercaseName}PageVO extends BaseVO {
